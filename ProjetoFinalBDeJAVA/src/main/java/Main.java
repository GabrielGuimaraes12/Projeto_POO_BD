...
public class Main {
    public static void main(String[] args) {
        ...
        while(flag){
            ...
            System.out.println("1 - Criando Personagens, Jogadores, Token e Servers");
            System.out.println("2 - Deletar Personagem ");
            System.out.println("3 - Informações Jogadores ");
            System.out.println("4 - Informações Personagens ");
